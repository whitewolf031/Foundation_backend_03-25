...
class Playlist:
    def __init__(self, name, list_of_playlist):
        self.name = name
        self.list_of_playlist = list_of_playlist

    def add_songs(self):
        n = self.list_of_playlist
        m = input("Qo'shiq kiriting: ")
        n.append(m)
        return n
...
obj = Playlist(["Tohir Sodiqov", "Hamdam Sobirov"], ["Mendirman osha"])
print(obj.add_songs())
